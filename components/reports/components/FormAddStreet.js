  ...
  return (
    <View style={styles.viewForm}>
      {/* MODIFICAR POR UN NOMBRE NADA MAS 
              ...
              />*/}
      <Text>FORMULARIO PARA POSTULACIÓN DE VÍA</Text>
      <Text
        style={{
      ...
      >
        "Dirección de la vía a postular..."
      </Text>
      <Input
      ...
      >
        "Cree usted que la vía postulada es de bajo transito?..."
      </Text>
      <Input
        containerStyle={styles.input}
        inputContainerStyle={{ borderColor: COLORS.secondary }}
      ...
      >
        "Sabe usted si la vía cuenta con redes de alcantarillado?..."
      </Text>
      <Input
